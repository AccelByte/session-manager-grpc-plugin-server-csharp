...
using Prometheus;
using AccelByte.PluginArch.SessionManager.Demo.Server.Services;
    ...
    public class Program
    {
        public static int Main(string[] args)
        {
            ...
            if (appServiceName == null)
                appServiceName = "extend-app-session-manager";
            else
                appServiceName = $"extend-app-sm-{appServiceName.Trim().ToLower()}";
            ...
            app.MapGrpcService<SessionManagerDemoService>();
